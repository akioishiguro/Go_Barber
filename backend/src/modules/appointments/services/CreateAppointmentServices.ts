...
class CreateAppointmentService {
  constructor(
    ...
    @inject('NotificationsReposotory')
    private notificationsReposotory: INotificationsRepository,
  ) {}
  ...
  public async execute({
    ...
    // Formatando a hora para poder enviar na notificaçao
    const dateFormatted = format(appointmentDate, "dd/MM/yyyy 'às' HH:mm 'h' ");

    // Criando Notificação
    await this.notificationsReposotory.create({
